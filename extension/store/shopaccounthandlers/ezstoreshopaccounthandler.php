...
class eZStoreShopAccountHandler
{
    function eZStoreShopAccountHandler()
    {
    ...
    */
    ...
    {
        $module->redirectTo( '/store/userregister/' );
    }
    ...
    */
    ...
    function accountInformation( $order )
    {
        ...
        if ( $xmlString != null )
        {
            ...
            $commentNode = $dom->getElementsByTagName( 'shipping' )->item( 0 );
            if ( $commentNode )
            {
                $shipping = $commentNode->textContent;
            }
            
            $commentNode = $dom->getElementsByTagName( 'payment' )->item( 0 );
            if ( $commentNode )
            {
                $payment = $commentNode->textContent;
            }
            
            $commentNode = $dom->getElementsByTagName( 'phone' )->item( 0 );
            if ( $commentNode )
            {
                $phone = $commentNode->textContent;
            }
        }
