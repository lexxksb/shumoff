...
{switch match=$:item_previous|lt(0) }
    {case match=0}
        <li class="previous"><a href={concat($page_uri,$:item_previous|gt(0)|choose('',concat($:offset_text,$:item_previous)),$:view_parameter_text,$page_uri_suffix)|ezurl}>&laquo;</a></li>
    {/case}
    {case match=1}
    {/case}
{/switch}
...
{if $:current_page|gt($:left_max)}
    ...
    {if sub($:current_page,$:left_length)|gt(1)}...{/if}
{/if}
...
{switch match=$:item_next|lt($item_count)}
    {case match=1}
        <li class="next"><a href={concat($page_uri,$:offset_text,$:item_next,$:view_parameter_text,$page_uri_suffix)|ezurl}>&raquo;</a></li>
    {/case}
    {case}
    {/case}
{/switch}
