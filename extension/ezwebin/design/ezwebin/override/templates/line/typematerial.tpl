    ...
    <div class="media">
        ...
        <div class="media-body">
            ...
            <div class="priceBlock">
                <span class="from">от</span>&nbsp;{$children[0].data_map.price.content.price|l10n( 'number' )}&nbsp;<span class="icon-ruble"></span>{if $children[0].data_map.unit.has_content}<span class="from">/{$children[0].data_map.unit.content}</span>{/if}
            </div>
        </div>
    </div>
</div>